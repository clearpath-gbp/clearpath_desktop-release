...
%global pkg_name clearpath_offboard_sensors
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-jazzy-clearpath-offboard-sensors
Version:        2.9.0
Release:        1%{?dist}
...
%description
Launch files for decompressing and consuming high-bandwidth sensor data on
offboard computers
...
%changelog
* Thu Jun 25 2026 Chris Iverach-Brereton <civerachb@clearpathrobotics.com> - 2.9.0-1
