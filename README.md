...
## clearpath_desktop (humble) - 1.2.0-1

The packages in the `clearpath_desktop` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_desktop -r humble -t humble` on `Fri, 14 Mar 2025 21:50:37 -0000`
...
The packages in the `clearpath_desktop` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_desktop -r jazzy -t jazzy` on `Thu, 30 Jan 2025 19:13:35 -0000`
...
The packages in the `clearpath_desktop` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_desktop -r humble -t humble --edit-track` on `Tue, 26 Nov 2024 04:55:44 -0000`
